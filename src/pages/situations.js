...
// import {ImagesSituations} from "../../../components"
  ...
  return (
    <div className={styles.galleryCats}>
      {/* <div className={styles.gallery}>
        ...
        >
          <Masonry gutter={gutter}>
            <img src={ImagesSituations.Dogs[8].src} alt="" />
            <img src={ImagesSituations.Dogs[9].src} alt="" />
            <img src={ImagesSituations.Dogs[10].src} alt="" />
          </Masonry>
        </ResponsiveMasonry> */}
        ...
        >
          <Masonry gutter={gutter}>
            <img src={ImagesSituations.Dogs[6].src} alt="" />
            <img src={ImagesSituations.Dogs[7].src} alt="" />
          </Masonry>
        </ResponsiveMasonry> */}
